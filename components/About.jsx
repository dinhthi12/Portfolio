...
const infoData = [
  ...
  },
  {
    ...
    text: "thi884641@gmail.com",
  },
  {
    icon: <Calendar size={20} />,
    text: "Born on 19 Oct, 2001",
  },
  {
...
const qualificationData = [
  ...
  },
  {
    ...
    data: [
      {
        company: "Sun* Inc. (Sun Asterisk Inc.) (Internship)",
        role: "Backend developer (Ruby - Rails)",
        ...
        <div className="flex flex-col xl:flex-row">
          ...
          <div className="hidden xl:flex flex-1 relative">
            <DevImg
              ...
              imgSrc="/about/Remove-bg.ai_1713323394121.png"
              alt="about me"
            />
          </div>
          {/* tabs */}
